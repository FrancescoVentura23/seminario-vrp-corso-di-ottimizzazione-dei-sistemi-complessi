...
> **Ordine delle parti** — la **Complexity** (Parte IV) è collocata **prima** del TSP e del CVRP: il deck introduce Big-O, classi P/NP/NP-hard **prima** che le slide TSP usino questo vocabolario per la generazione lazy dei vincoli DFJ. Le slide sugli **algoritmi esatti** (`Slide17C`) e **perché usare le euristiche** (`Slide18`) sono invece collocate in **Part VIII**, subito dopo l'intestazione Clarke-Wright (slide 54), così da motivare l'euristica nel momento in cui viene introdotta. La numerazione dei file `.jsx` (`05-tsp.jsx`, `06-cvrp.jsx`, `07-complexity.jsx`) riflette l'ordine *di creazione* dei file, non l'ordine di rendering — l'array `slides[]` in [vrp-seminar.html](project/vrp-seminar.html) è la fonte autoritativa dell'ordine effettivo.
...
| 25 | **Part V — TSP** *(section header)* | `SlideTSPSection` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 26 | TSP — informal statement | `Slide09` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 27 | Hamiltonian circuit (animated) | `SlideTSPHamiltonian` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 28 | TSP — ILP formulation | `SlideTSPFormulation` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 29 | Degree constraints | `SlideTSPDegree` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 30 | The subtour problem (animated) | `SlideTSPSubtourProblem` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 31 | DFJ subtour elimination | `SlideTSPDFJ` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 32 | Exponential blow-up (animated) | `SlideTSPExponential` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 33 | Lazy subtour cuts in branch-and-cut | `SlideTSPLazy` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 34 | The key identity: relating cuts to arcs | `SlideTSPKeyIdentity` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
| 35 | Separation = min-cut (animated) | `SlideTSPMinCut` | [slides/05-tsp.jsx](project/slides/05-tsp.jsx) |
