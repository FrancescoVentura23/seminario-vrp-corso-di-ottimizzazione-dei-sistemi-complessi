/* =========================================================================
   VRP Seminar — Part II: Foundations (graph theory)
   Slides: section header, Node, Node attributes, Edge, Simple graph,
           Directed arc, Digraph, Forward/backward star, Network
   ========================================================================= */
...
Object.assign(window, {
  Slide05,
  SlideNode, SlideNodeAttributes, SlideEdge, SlideSimpleGraph,
  SlideDirectedArc, SlideDigraph, SlideStarNotation, SlideNetwork,
});
